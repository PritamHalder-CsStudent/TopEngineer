...
const Contact = () => {
  return (
     <div className="max-w-5xl w-full mx-auto p-10 text-gray-800">
            <span className="px-4 py-2 text-xs border border-red-300 rounded-full">Reach Out To Us</span>
            <h1 className="text-4xl font-bold text-left mt-4">
                We are availavle to provide services 24/7 .
            </h1>
            <p className="text-left mt-4">
                Or just reach out manually to  
                <a href="mailto:topengineer@gmail.in" className="text-red-500 hover:underline"> topengineer@gmail.in</a>
            </p>
            <div className="grid md:grid-cols-3 mt-16">
                <div>
                    <svg className="text-red-500 bg-indigo-500/20 p-2.5 aspect-square rounded-full size-10" width="24"
                    ...
                    <a href="mailto:topengineer@gmail.in" className="text-indigo-600 font-semibold">
                        topengineer@gmail.in
                    </a>
                </div>
                <div>
                    <svg className="text-red-500 bg-indigo-500/20 p-2.5 aspect-square rounded-full size-10" width="24"
                    ...
                    <span className="text-indigo-500 font-semibold">
                        14/21 New Ballygung,Kasba,KOLKATA-700039
                    </span>
                </div>
                <div>
                    <svg className="text-red-500 bg-indigo-500/20 p-2.5 aspect-square rounded-full size-10" width="21"
